window.onload = function() {
    ...
    document.querySelector(".sq").addEventListener("click", function () {
        ...
        if (screen.innerHTML === "") {
            ...
            output = screen.innerHTML = Math.pow(value, 2);
    ...
    document.querySelector(".sqrt").addEventListener("click", function () {
        ...
        if (screen.innerHTML === "") {
            ...
            output = screen.innerHTML = Math.sqrt(value);
    ...
    document.querySelector(".cube").addEventListener("click", function () {
        ...
        if (screen.innerHTML === "") {
            ...
            // output = screen.innerHTML = Math.sqrt(value);
            output = screen.innerHTML = Math.pow(value, 3);
        }
